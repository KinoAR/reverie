...
class ColorUtils {
   ...
   * @param a Int 0-255
   */
  public static function fromRGBInt(r:Int, g:Int, b:Int, a:Int=255) {
   ...
   * @param a Float 0-1
   */
  public static function fromRGBF(r:Float, g:Float, b:Float, a:Float=1) {
   ...
   * @param value 
   */
  public static function fromHTMLStr(value:String) {
